...
<body>
    ...
    <div class="container">
        ...
        <div class="row jumbotron">
            <h2>Animal Data
                <br>
                <span class="text-muted">Exotics</span>
            </h2>
      ...
      if (switchcount == 0 && dir == "asc") {
       ...
       $(document).ready(function () {
            ...
            $.ajax({
                ...
                let triangle_worthy = ['name','species','sex','owners'];
                Object.keys(data.exotics[0]).forEach( (key) => {
                ...
                $("thead > tr > th").on( "click", function(event) {
                   ...
                   $.each(data.exotics, function (index) {
                   
                    let indy = index+1;
                    let age = (string) => { 
                        return new Date().getFullYear() - new Date(string).getFullYear() 
                    };
                    $(".modal-body").append(data.exotics[index].owners);
                    $(".modal-body2").append("<span>" + data.exotics[index].notes+ "</span>");
                    $("tbody").append(
                            "<tr>" + "<th scope='row'>" + indy + 
                            "</th>" +
                            "<td>" + data.exotics[index].name + "</td>" +
                            "<td>" + data.exotics[index].species +  "</td>" +
                            "<td>" + data.exotics[index].sex.toUpperCase() + "</td>" +
                            "<td>" + age(data.exotics[index].age) + "</td>" +
