...
<body>
    ...
    <div class="container">
        ...
        <div class="row jumbotron">
            <h2>Animal Data
                <br>
                <span class="text-muted">Cats</span>
            </h2>
      ...
      if (switchcount == 0 && dir == "asc") {
       ...
       $(document).ready(function () {
            ...
            $.ajax({
                ...
                Object.keys(data.cats[0]).forEach( (key) => {
                ...
                $("thead > tr > th").on( "click", function(event) {
                   ...
                   $.each(data.cats, function (index) {
                    ...
                    $("div.modal-body").append(data.cats[index].owners);
                    $("div.modal-body2").append("<span>" + data.cats[index].notes+ "</span>");
                    $("tbody").append(
                            "<tr>" + "<th scope='row'>" + indy + 
                            "</th>" +
                            "<td>" + data.cats[index].name + "</td>" +
                            "<td>" + data.cats[index].breed +  "</td>" +
                            "<td>" + data.cats[index].sex.toUpperCase() + "</td>" +
                            "<td>" + age(data.cats[index].age) + "</td>" +
                            "<td>" + (data.cats[index].neutered == 1 ? "Yes"
                            : "No") + "</td>" +
                            "<td>" + (data.cats[index].declawed == 1 ? "Yes"
                            : "No") + "</td>" +
                            "<td>" + (data.cats[index].shots == 1 ? "Yes"
                            : "No") + "</td>" +
